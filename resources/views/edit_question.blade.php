                  ...
                  <form class="form-sample" method='post' action='{{url('add_question')}}'>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12" id='multi_con' style='display:none'>
                        ...
                        <div class="form-group row">
                          <input type="checkbox" name='multi_opt[]' value='2'/><input type='text' class='opt_lable_text' name='opt_label[]' value='Option 3'/>
                        </div>
                        <div class="form-group row">
                          <input type="checkbox" name='multi_opt[]' value='3'/><input type='text' class='opt_lable_text' name='opt_label[]' value='Option 4'/>
                        </div>
                        <div class="form-group row">
                          <input type="checkbox" name='multi_opt[]' value='4'/><input type='text' class='opt_lable_text' name='opt_label[]' value='Option 5'/>
                        </div>
                        <div class="form-group row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="sts_opt" id="membershipRadios2" value="0">
                                Inactive
                              <i class="input-helper"></i></label>
                            </div>
                          </div>
                            ...
                            <td>
                                @if ($question->is_active==1)
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" url_ref='{{URL::signedRoute('change_status', ['questionId' => $question->id])}}' checked class="custom-control-input" id="status_switch_{{$question->id}}">
                                        <label class="custom-control-label" for="status_switch_{{$question->id}}"></label>
                                    </div>
                                @else
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" url_ref='{{URL::signedRoute('change_status', ['questionId' => $question->id])}}' class="custom-control-input" id="status_switch_{{$question->id}}">
                                        <label class="custom-control-label" for="status_switch_{{$question->id}}"></label>
                                    </div>
                                @endif
                            </td>
