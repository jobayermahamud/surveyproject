                ...
                <div class="card-body">
                  ...
                  @if (Session::has('error'))
                      <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Required!</strong> {{Session::get('error')}}
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Survey name</label>
                          <div class="col-sm-9">
                            <input type="text" name='survey_name' value='{{$surveyDetails[0]->survey_name}}' class="form-control">
                          </div>
                        </div>
                      </div>
                      <hr>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" name='date_from' value='{{$surveyDetails[0]->date_from}}' class="form-control">
                          </div>
                        </div>
                      </div>
                      <hr>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" name='date_to' value='{{$surveyDetails[0]->date_to}}' class="form-control">
                          </div>
                        </div>
                      </div>
                      <hr>
